...
<div class="h-content">
	<h3>软件介绍</h3>
	<p>
《好好修车》是全网最智能的汽车故障判断软件，您口袋里的免费修车老师。这里有中国最智慧的汽车故障一键查询和系统分析系统；
最海量的汽车维修案例助您安心修车，最齐全的匹配正时电脑编程资让你轻松成为汽修百事通；
还有高级维修专家入驻社区为您提供贴心服务，一对一答疑让您百分百放心；
还能一键发布简历信息，跳槽求职更无忧！
这里，更有答题助人赢积分，兑换现金礼品等活动。
	</p>
	<p>APP软件功能：
		<ul>
			<li>查现象：通过查故障现象提供全方位故障点诊断方向；</li>
			<li>查故障：通过查故障点精确找到最佳解决方案；</li>
			<li>查案例：互联网汽车维修案例的集中地；</li>
			<li>查故障码：通过故障编码，判断故障点后提供解决方案；</li>
			<li>匹配正时：电脑编程，防盗匹配、保养归零复位一键查询。</li>
			<li>助人修车：帮忙车主提升自己，赢积分，兑好礼。</li>
			<li>汽修社区：
				1) 问答（分享经验，技术切磋广场）；
				2) 吐槽（随意发表自己的见解）；
				3) 求职（一键发布求职简历）。
